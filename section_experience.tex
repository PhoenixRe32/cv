...
%\renewcommand{\labelitemi}{$\bullet$}
  \begin{experiences}
    \experience
      {Current}
      {Senior Software Engineer}{Loveholidays (Contractor)}{London - UK}
      {March 2019}
      {
        \emph{Holiday planning site and backoffice support system}
        \begin{itemize}
          \item Created microservice for email integration with backoffice
          \item Improved performance of backoffice
        \end{itemize}
      }
